...
// 獲取桌次的座位編號順序（根據順時鐘排列邏輯）
function getSeatNumbers(tableNum) {
    const seatNumbers = {
        'A7': [1, 2, 3, 4], // 菱形桌，4個座位
        'B8': [1, 2, 3, 4, 5, 6, 12, 11, 10, 9, 8, 7], // 橫排 6×2，順時鐘排列
        'B2': [7, 14, 6, 13, 5, 12, 4, 11, 3, 10, 2, 9, 1, 8], // 直排 2×7，順時鐘排列
        'A2': [5, 10, 4, 9, 3, 8, 2, 7, 1, 6], // 直排 2×5，順時鐘排列
        'C2': [5, 10, 4, 9, 3, 8, 2, 7, 1, 6], // 直排 2×5，順時鐘排列
        'C1': [5, 10, 4, 9, 3, 8, 2, 7, 1, 6], // 直排 2×5，順時鐘排列
        'A1': [4, 8, 3, 7, 2, 6, 1, 5], // 直排 2×4，順時鐘排列
        'B1': [3, 6, 2, 5, 1, 4] // 直排 2×3，順時鐘排列
    };
